...
from challenge43 import sha1, DSA, mod_inv, get_x_from_k
...
if __name__ == '__main__':
    ...
    print(sha1(c) == "ca8f6f7c66fa362d40760d135b763eb8527d3d52")
    print(pow(DSA.DEFAULT_G, hacked_x, DSA.DEFAULT_P) == y)